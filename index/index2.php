    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <img src="imgs/icon11.png" style="height:32px; display:inline-block; margin-top:5px; margin-right:25px;">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <p>
                    <a class="btn btn-default btn-lg" href="https://play.google.com/store/apps/details?id=com.receyecle.app">Get the App &raquo;</a>
                </p>
            </div>
            <div class="col-sm-4">
                <h2>Contact Us</h2>
        ...
        <figure>
            <div class="slide">
                <h3>In America alone we use 2.5 million plastic bottles each hour! <sup><a href="http://earth911.com/recycling-guide/how-to-recycle-plastic-jugs-bottles/"> &#xf0c1;</a></sup></h3>
            </div>

            <div class="slide">
                <h3>Plastic Bottles don't biodegeade, which means that if you don't properly recycle them, they will sit in a landfill for hundreds of years before they fully decompose. <sup><a href="http://earth911.com/recycling-guide/how-to-recycle-plastic-jugs-bottles/"> &#xf0c1;</a></sup></h3>
            </div>

            <div class="slide">
                <h3>One dirty product, or one with food waste still in it can contaminate an entire bale, containing thousands of pounds of collected plastics. This can cause thousands of recyclable items to go to a landfill instead of being recycled. <sup><a href="http://www.wm.com/thinkgreen/what-can-i-recycle.jsp"> &#xf0c1;</a></sup></h3>
            </div>

            <div class="slide">
               <h3>PET plastic is the most common material used for single-use bottled beverages, because it is inexpensive, lightweight, unbreakable and easy to recycle. It takes more than 1.5 million barrels of oil to produce a year's supply of water bottles. That's enough oil to fuel 100,000 cars for a year! <sup><a href="http://www.wm.com/thinkgreen/what-can-i-recycle.jsp"> &#xf0c1;</a></sup></h3>
            </div>

            <div class="slide">
                <h3>When U.S. recycling levels reach 75% it will be the environmental and CO2 equivalent of removing 55 million cars from U.S. roads each year. <sup><a href="http://www.recycleacrossamerica.org/recycling-facts"> &#xf0c1;</a></sup></h3>
            </div>
            <div class="slide">
                <h3>Recycling a single aluminum can saves enough energy to power a TV for three hours. <sup><a href="http://www.recycleacrossamerica.org/recycling-facts"> &#xf0c1;</a></sup></h3>
            </div>
            <div class="slide">
                <h3>More than 28 billion glass bottles and jars end up in landfills every year -- that is the equivalent of filling up two Empire State Buildings every three weeks. <sup><a href="http://www.recycleacrossamerica.org/recycling-facts"> &#xf0c1;</a></sup></h3>
            </div>
            <div class="slide">
                <h3>Recycling one ton of plastic bottles saves the equivalent energy usage of a two person household for one year! <sup><a href="http://www.recycleacrossamerica.org/recycling-facts"> &#xf0c1;</a></sup></h3>
            </div>
            <div class="slide">
                <h3>Half a million trees have to be cut down just to produce the Sunday newspapers each week. With that said, recycling a single days worth of the New York Times could save 75,000 trees or more. <sup><a href="http://www.conserve-energy-future.com/various-recycling-facts.php"> &#xf0c1;</a></sup></h3>
            </div>
            <div class="slide">
                <h3>Plastic bags that are thrown into the ocean kill over a million sea creatures a year. <sup><a href="http://www.conserve-energy-future.com/various-recycling-facts.php"> &#xf0c1;</a></sup></h3>
            </div>
            <div class="slide">
                <h3>The top American cities for recycling are 1) San Francisco, 2) Boston, 3) Chicago, 4) Denver, and 5) Portland. <sup><a href="https://www.factretriever.com/recycling-facts"> &#xf0c1;</a></sup></h3>
            </div>
            <div class="slide">
                <h3>A used aluminum can is recycled and back in use as a new can in as little as 60 days. <sup><a href="http://www.recyclingbin.com/Recycling-Facts"> &#xf0c1;</a></sup></h3>
            </div>
        </figure>
    </div>
        <hr>
